    ...
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-white/5" style={{ background: "rgba(10, 15, 26, 0.85)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)" }}>
      <div className="container flex h-16 items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="hidden font-heading text-lg font-bold text-white sm:inline">
        ...
        <div className="flex items-center gap-3">
          <Link href="/search" className="rounded-lg p-2 text-gray-400 transition-colors hover:bg-white/5 hover:text-white">
          ...
          {user ? (
            ...
            <Link
              href="/sign-in"
              className="rounded-xl bg-gradient-to-r from-pd-purple to-pd-blue px-4 py-2 text-sm font-medium text-white transition-all hover:from-pd-gold hover:to-pd-gold-light hover:text-pd-dark"
            >
              Sign In
            </Link>
          )}
